...
<body class="bg-pink-300 min-h-screen">
    ...
    <nav class="bg-pink-500 text-white p-4 flex justify-between items-center">
        <div class="font-bold text-xl">VIZTA Family KTV</div>
        <ul class="flex space-x-4 relative">
            <li><a href="#" class="hover:text-gray-200">HOME</a></li>
            <li><a href="#" class="hover:text-gray-200">NEWS</a></li>
            <li class="relative group">
                <a href="#" class="hover:text-gray-200">OUTLET</a>
            ...
            <li class="relative group">
                <a href="#" class="hover:text-gray-200">SYSTEM</a>
                <ul class="absolute hidden group-hover:block bg-pink-600 text-white mt-2 py-2 w-48 z-10">
            ...
            <li class="relative group">
                <a href="#" class="hover:text-gray-200">INFO</a>
                <ul class="absolute hidden group-hover:block bg-pink-600 text-white mt-2 py-2 w-48 z-10">
    ...
    <div class="relative">
        ...
        <h1 class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-3xl font-bold">BLOG POST</h1>
    </div>
